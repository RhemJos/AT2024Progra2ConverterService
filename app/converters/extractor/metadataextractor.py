import platform
from app.utils import CommandExecutor, Formatter
from app.converters.extractor.extractor import Extractor
...
class MetadataExtractor(Extractor):
    def extract(self):
        ...
        cmd = CommandExecutor()
        exif_tool_path = cmd.get_execfile_path("\\app\\converters\\extractor\\bin\\exifTool\\exifTool{}".format(exif_tool_distribution) )
